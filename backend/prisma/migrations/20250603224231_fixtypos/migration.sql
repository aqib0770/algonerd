/*
  ...
  - You are about to drop the `TestCaseResults` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "TestCaseResults" DROP CONSTRAINT "TestCaseResults_submissionId_fkey";

-- DropTable
DROP TABLE "TestCaseResults";
